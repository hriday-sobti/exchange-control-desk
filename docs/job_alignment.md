...
| **Business Intelligence & Reporting** | Communicating operational status, platform liquidity, risk exposures, and data integrity to leadership. | 5-Page Power BI architecture with DAX measures, star-schema semantic model, and executive summary reports. | `powerbi/measures/measures.dax`<br>`docs/dashboard_guide.md`<br>`outputs/executive/executive_summary.md` |
